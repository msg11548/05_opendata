...
# Introduction  
The practice of finding better representations of predictors (i.e., features) to improve predictive performance is referred to as “feature engineering.” (dirive new forms representation of data, create new columns from the ones we have now)
